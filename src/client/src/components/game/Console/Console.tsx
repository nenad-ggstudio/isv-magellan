...
export function Console({ debugLine, tick }: ConsoleProps) {
  return (
    <section
      className={cx(
        panelSurface,
    ...
    >
      ...
      <div className="min-h-0 overflow-auto rounded-md border border-[#243033] bg-[#020405] p-3.5 font-mono text-[13px] leading-normal text-[#84cdb8]">
        <p className="m-0 mb-1">&gt; Game engine link pending commands.</p>
        <p className="m-0 mb-1">&gt; Worker tick received: {tick || '--'}.</p>
        <p className="m-0 mb-1 break-words">&gt; Stellar debug: {debugLine}</p>
